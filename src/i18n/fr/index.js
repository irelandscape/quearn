...
export default {
  ...
  createaccountoptions: 'Les options suivantes sont disponible pour creer votre compte:',
  edit: 'Editer',
  ...
  ok: 'OK',
  questionrequirement: 'Votre Question (doit finir avec un point d\'interrogation!)',
  ...
  reply: 'Repondre',
  requesttags: 'Ajoutez jusqu\'a 3 tags ("Entree" entre chaque tag)',
